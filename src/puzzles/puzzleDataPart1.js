// Part 1: Original 13 puzzle definitions (Lessons 1-16)
...
const part1 = [
  ...
  // ---- Puzzle 5: Turn to Banana ----
  {
    ...
    part: 1,
    lesson: 3,
    lessonTitle: 'turnTo & distanceTo',
    title: 'Turn to Banana',
    concept: 'turnTo',
    gridWidth: 8,
    gridHeight: 3,
    monkeyStart: { x: 0, y: 1, direction: 1 },
    entities: [
      { type: 'banana', x: 6, y: 1 },
    ],
    autoGrab: true,
  ...
  // ---- Puzzle 13: Function Junction ----
  {
    ...
    part: 1,
    lesson: 9,
    lessonTitle: 'Intro to Functions',
