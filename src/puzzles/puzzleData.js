...
const puzzles = [
  ...
  // ---- Puzzle 7: Turn To + Distance To ----
  {
    ...
    hint: 'After grabbing the first banana, use turnTo bananas[1] and step distanceTo bananas[1] to reach the second one.',
  ...
  // ---- Puzzle 8: Watch Out for Bushes! ----
  {
    ...
    hint: 'Go right 2 steps, turn right to go down, step past the bushes, turn left, step right, then turn left and go up to the banana.',
    starThresholds: [10, 8, 7],
  },
  ...
  // ---- Puzzle 9: Loop the Loop ----
  {
    ...
    hint: 'A for loop repeats code. for i in [1..4] runs the indented code 4 times. Step 1 and grab inside the loop!',
    starThresholds: [4, 3, 3],
  },
  ...
  // ---- Puzzle 11: Loop with turnTo ----
  {
    ...
    hint: 'Use for b in bananas to go through each banana. Inside the loop: turnTo b, step distanceTo b, grab.',
  ...
  // ---- Puzzle 13: Function Junction ----
  {
    ...
    hint: 'Create a function: goGet = () -> then indent step 2 and grab below it. Call it 3 times: goGet() or use a loop!',
